...
export default function AdminDashboardPage() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: formatCurrency(stats.totalEndowment),
      icon: Banknote,
  ...
  const alertCards = [
    {
      label: `${pendingCommunities.length} komunitas`,
    ...
    {
      label: `${pendingActivities.length} kegiatan`,
    ...
    {
      label: `${pendingReports.length} laporan`,
    ...
    },
    {
      ...
      sub: "Menunggu verifikasi data diri",
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Ringkasan aktivitas platform SinergiLaut
              </p>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
              ...
              <CardHeader className="flex flex-row items-center justify-between pb-3">
                <div>
                  <CardTitle className="text-base flex items-center gap-2">
                    <Clock className="h-4 w-4 text-yellow-500" /> Komunitas
                    Pending
                  </CardTitle>
                ...
                {pendingCommunities.length === 0 ? (
                  ...
                  <div className="space-y-2">
                    {pendingCommunities.slice(0, 3).map((c) => (
                      <div
                        key={c.id}
                        className="flex items-center justify-between gap-3 p-3 bg-secondary rounded-lg border-l-4 border-l-yellow-400"
                      >
                        ...
                        <div className="flex gap-1.5 flex-shrink-0">
                          <Button
                            ...
                            onClick={() => handleApprove("Komunitas", c.id)}
                          >
                          ...
                          <Button
                            ...
                            onClick={() => handleReject("Komunitas", c.id)}
                          >
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-3">
                <div>
                  <CardTitle className="text-base flex items-center gap-2">
                    <Activity className="h-4 w-4 text-blue-500" /> Kegiatan
                    Pending
                  </CardTitle>
                ...
                {pendingActivities.length === 0 ? (
                  ...
                  <div className="space-y-2">
                    {pendingActivities.slice(0, 3).map((a) => (
                      <div
                        key={a.id}
                        className="flex items-center justify-between gap-3 p-3 bg-secondary rounded-lg border-l-4 border-l-blue-400"
                      >
                        <div className="min-w-0">
                          <p className="font-medium text-sm text-foreground truncate">
                            {a.title}
                          ...
                          <p className="text-xs text-muted-foreground">
                            {a.community?.name} • {formatDate(a.start_date)}
                          </p>
                        </div>
                        <div className="flex gap-1.5 flex-shrink-0">
                          <Button
                          ...
                          <Button
                            size="sm"
                            className="h-7 px-2 bg-green-600 hover:bg-green-700 text-xs"
                            onClick={() => handleApprove("Kegiatan", a.id)}
                          >
                          ...
                          <Button
                            ...
                            variant="destructive"
                            className="h-7 px-2 text-xs"
                            onClick={() => handleReject("Kegiatan", a.id)}
                          >
                            <X className="h-3.5 w-3.5" />
                          </Button>
                        </div>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-3">
                <div>
                  <CardTitle className="text-base flex items-center gap-2">
                    <FileText className="h-4 w-4 text-green-500" /> Laporan
                    Pending
                  </CardTitle>
                ...
                {pendingReports.length === 0 ? (
                  ...
                  <div className="space-y-2">
                    {pendingReports.slice(0, 3).map((r) => (
                      <div
                        key={r.id}
                        className="flex items-center justify-between gap-3 p-3 bg-secondary rounded-lg border-l-4 border-l-green-400"
                      >
                        <div className="min-w-0">
                          <p className="font-medium text-sm text-foreground truncate">
                            {r.activity?.title || "Kegiatan"}
                          </p>
                          <p className="text-xs text-muted-foreground">
                            {r.community?.name} • {formatDate(r.created_at)}
                          </p>
                        </div>
                      </div>
                    ))}
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-3">
                <div>
                  <CardTitle className="text-base flex items-center gap-2">
                    <UserCheck className="h-4 w-4 text-purple-500" /> Verifikasi
                    Pengguna
                  </CardTitle>
                  <CardDescription>
                    Data diri perlu diverifikasi
                  </CardDescription>
                </div>
                <Button variant="ghost" size="sm" asChild>
              ...
              <CardContent>
                <div className="text-center py-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    pengguna menunggu verifikasi data diri
                  </p>
                  {pendingVolunteers > 0 && (
